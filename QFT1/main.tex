...
\begin{titlepage}
	\centering
	    ...
	    {\LARGE QFT I (Path Integrals)} % Title
	    ...
	    {\scshape\Large Dr. Douglas Smith} % Lecturer Name
...
These are my notes on the 2019 lecture course "QFT I" taught by Dr. Douglas Smith at Durham University as part of the Particles, Strings and Cosmology Msc. For reference, the course lasted 8 hours and was taught over the course of 4 weeks. This course is really meant more as an introduction to path integrals then a study of QFT. The module QFT II will do the actual QFT. \\
...
I would like to extend a message of thanks to Dr. Smith for teaching this course. \\
...
These notes are not endorsed by Dr. Smith or Durham University.
...
\input{sections/01PI.tex}
\input{sections/02greens.tex}
\input{sections/03SD.tex}
\input{sections/04Perturbation.tex}
